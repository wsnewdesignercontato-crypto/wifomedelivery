    ...
    items: [
      {
        ...
        label: "Meus dados",
        desc: "Nome, telefone, foto, RG, CPF",
        icon: User,
      },
      {
        to: "/entregador/veiculo",
        label: "Meu veículo",
        desc: "Marca, modelo, placa, ano",
        icon: Car,
      },
      {
        to: "/entregador/documentos",
        label: "Documentos (KYC)",
        desc: "CNH, selfie, comprovantes",
        icon: FileText,
        kyc: true,
      },
    ],
    ...
    items: [
      {
        ...
        desc: "PIX, banco, titular",
        icon: CreditCard,
      },
      {
        to: "/entregador/carteira",
        label: "Carteira e saques",
        desc: "Saldo, saque via PIX",
        icon: Wallet,
      },
    ],
  },
    ...
    items: [
      {
        ...
        label: "Notificações",
        desc: "Alertas de corridas",
        icon: Bell,
      },
      {
        to: "/entregador/configuracoes",
        label: "Configurações",
        desc: "Som, GPS, privacidade",
        icon: Settings,
      },
    ],
  },
      ...
      {kycState !== "approved" && (
        <div className="rounded-2xl border border-amber-300 bg-amber-50 dark:bg-amber-950/30 p-4 text-sm">
          ...
          <p className="mt-1 text-xs text-amber-800 dark:text-amber-300">
            Envie sua CNH, selfie e comprovantes em <b>Documentos</b>. Sem validação você não
            consegue solicitar saques.
          </p>
        </div>
      )}
