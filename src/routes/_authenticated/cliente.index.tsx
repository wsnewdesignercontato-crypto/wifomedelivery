  ...
  useEffect(() => {
    (async () => {
      ...
      let estabQ = supabase
        .from("establishments")
        .select(
          "id,nome,descricao,categoria_id,logo_url,capa_url,taxa_entrega_cents,tempo_medio_min,avaliacao,is_open,cidade",
        )
        .eq("status", "aprovado")
        .eq("is_open", true);
        ...
        fallback={
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col justify-center p-5">
              ...
              <p className="text-2xl font-black leading-tight text-primary drop-shadow-lg sm:text-3xl">
                3 entregas
              </p>
            </div>
          </button>
