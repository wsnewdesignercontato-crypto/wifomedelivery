    ...
    items: [
      {
        ...
        label: "Clube WiFome",
        desc: "Assinatura com fretes grátis",
        icon: Crown,
        accent: true,
      },
      {
        to: "/cliente/perfil/recompensas",
        label: "Recompensas e benefícios",
