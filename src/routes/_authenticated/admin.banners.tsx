...
function BannersPage() {
  ...
  async function create() {
    ...
    setOpen(false);
    setF({ titulo: "", image_url: "", link_url: "", posicao: 0 });
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Banners rotativos exibidos no app do cliente.
          </p>
        </div>
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <Input
                  type="number"
                  value={f.posicao}
                  onChange={(e) => setF({ ...f, posicao: Number(e.target.value) })}
                />
              </div>
            ...
            <div className="p-4">
              <div className="flex items-start justify-between gap-2">
                ...
                <div className="flex gap-1">
                  <button
                    onClick={() => toggle(b)}
                    className={`rounded-full px-2 py-0.5 text-xs ${b.ativo ? "bg-emerald-500/10 text-emerald-600" : "bg-muted text-muted-foreground"}`}
                  >
