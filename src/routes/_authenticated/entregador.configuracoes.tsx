...
const FAQS = [
  {
    q: "Como aceitar uma corrida?",
    a: "Fique online no painel Início e toque em Aceitar quando uma corrida aparecer. Só um entregador pode aceitar por corrida.",
  },
  {
    q: "Como confirmar a entrega?",
    a: "Peça o código de 4 dígitos ao cliente. Se for entrega sem contato, envie a foto da prova de entrega.",
  },
  {
    q: "Quando recebo meus ganhos?",
    a: "Os ganhos ficam disponíveis para saque via Pix após a entrega ser finalizada, respeitando as regras da plataforma.",
  },
  {
    q: "Meu KYC foi recusado, e agora?",
    a: "Vá em Perfil → Documentos, corrija o que foi apontado e reenvie para nova análise.",
  },
];
...
function Cfg() {
  ...
  async function pedirPermissao() {
    if (typeof Notification === "undefined")
      return toast.error("Navegador sem suporte a notificações");
  ...
  const notifRows: Array<{ key: keyof Prefs; icon: typeof Bell; title: string; desc: string }> = [
    {
      key: "push_corridas",
      icon: Bell,
      title: "Push — Novas corridas",
      desc: "Alerta imediato quando surgir uma corrida",
    },
    {
      key: "som_corridas",
      icon: Volume2,
      title: "Som de corrida",
      desc: "Sirene para não perder pedidos",
    },
    {
      key: "alto_volume",
      icon: Volume2,
      title: "Volume alto",
      desc: "Reforça o som mesmo com o celular no bolso",
    },
    { key: "vibracao", icon: Vibrate, title: "Vibração", desc: "Vibrar em alertas importantes" },
    {
      key: "push_pagamento",
      icon: Bell,
      title: "Push — Pagamentos e saques",
      desc: "Aviso quando o saque cair no Pix",
    },
    {
      key: "push_promos",
      icon: Bell,
      title: "Push — Bônus e promoções",
      desc: "Metas e incentivos da plataforma",
    },
    {
      key: "email_recibos",
      icon: Mail,
      title: "E-mail — Recibos e extratos",
      desc: "Comprovantes semanais no seu inbox",
    },
    {
      key: "whatsapp",
      icon: MessageCircle,
      title: "WhatsApp",
      desc: "Atualizações importantes via WhatsApp",
    },
  ];
  ...
  const devRows: Array<{ key: keyof Prefs; icon: typeof Bell; title: string; desc: string }> = [
    {
      ...
      icon: MapPin,
      title: "Localização",
      desc: "GPS para receber corridas próximas",
    },
    {
      key: "modo_escuro_auto",
      icon: Moon,
      title: "Modo escuro automático",
      desc: "Segue a preferência do sistema",
    },
    {
      key: "economia_dados",
      icon: Wifi,
      title: "Economia de dados",
      desc: "Imagens em qualidade menor",
    },
  ];
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Ajuste alertas, dispositivo, conta e suporte.
        </p>
      </div>
      ...
      <section>
        ...
        <div className="grid grid-cols-3 gap-2">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex flex-col items-center gap-1 rounded-2xl border border-border bg-card p-3 text-center hover:bg-muted/40"
          >
            <MessageCircle className="h-5 w-5 text-primary" />
            <span className="text-xs font-semibold">Chat</span>
          </a>
          <a
            href="mailto:entregador@wifome.com.br"
            className="flex flex-col items-center gap-1 rounded-2xl border border-border bg-card p-3 text-center hover:bg-muted/40"
          >
